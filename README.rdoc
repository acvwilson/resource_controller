This fork is for applications that are using xml instead of html by default.
...
Install it as a plugin:
  ...
  script/plugin install git://github.com/acvwilson/resource_controller.git 
  
Or grab the source
  
  git clone git://github.com/acvwilson/resource_controller.git 
...
This fork maintained by Asa Wilson
